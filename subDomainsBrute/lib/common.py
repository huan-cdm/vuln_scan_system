...
def load_next_sub(options):
    next_subs = []
    _file = '/TIP/flask_cnvd/subDomainsBrute/dict/next_sub_full.txt' if options.full_scan else '/TIP/flask_cnvd/subDomainsBrute/dict/next_sub.txt'
...
def get_sub_file_path(options):
    if options.full_scan and options.file == 'subnames.txt':
        sub_file_path = '/TIP/flask_cnvd/subDomainsBrute/dict/subnames_full.txt'
    else:
        if os.path.exists(options.file):
            sub_file_path = options.file
        elif os.path.exists('/TIP/flask_cnvd/subDomainsBrute/dict/%s' % options.file):
            sub_file_path = '/TIP/flask_cnvd/subDomainsBrute/dict/%s' % options.file
        else:
